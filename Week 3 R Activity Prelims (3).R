...
#TASK: Write the function that returns the top row
head (women1,2)
...
just_height<-(women1$height)
just_weight<-(women1$weight)
...
height_and_weight<-data.frame(just_height,just_weight)
...
data.frame(table(height_and_weight))
